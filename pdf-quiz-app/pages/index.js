      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-extrabold text-gray-900 mb-6 tracking-tight">
            Note Nibbler
            <span className="block text-blue-600">Study Smarter, Not Harder</span>
          </h1>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-16">
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600">Our AI understands your documents and extracts key concepts automatically.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600">Adaptive quizzes that focus on your weak spots and help reinforce key concepts.</p>
          </div>
        ...
        <div className="mt-20 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-8">Trusted by Students and Professionals</h2>
          <div className="flex justify-center space-x-8">
            <div className="text-gray-500">⭐️ 4.9/5 Average Rating</div>
            <div className="text-gray-500">📚 10,000+ Documents Processed</div>
            <div className="text-gray-500">👥 5,000+ Active Users</div>
          </div>
        </div>
      </div>
    </div>
